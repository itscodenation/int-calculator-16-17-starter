$(document).ready(function() {
	...
	$('.calc-btn').click(function() {
		...
		if (state == 0) {
			...
			{
				if (operator == '/')
					answer = divide(parseInt(first_operand), parseInt(second_operand)); else if (operator == "x")
					answer = multiply(parseInt(first_operand), parseInt(second_operand));	 else if (operator == "-")
					answer = subtract(parseInt(first_operand), parseInt(second_operand));	 else if (operator == "+")
					answer = add(parseInt(first_operand), parseInt(second_operand));	 else if (operator == "^")
